...
export type GetSpotQuery = { __typename?: 'Query', spot?: { __typename?: 'Spot', id: string, title: string, description?: string | null, address: string, priceRange?: PriceRange | null, businessHours?: string | null, likeCount: number, isLiked?: boolean | null, createdAt: any, images: Array<{ __typename?: 'SpotImage', id: string, url: string, order: number }>, category: { __typename?: 'Category', id: string, name: string }, user: { __typename?: 'User', id: string, name: string, avatarUrl?: string | null } } | null };
